...
{
    [ApplicationInfo(Description = "UniscanSlice CLI Options")]
    public class Options
    {
        ...
        [NamedArgument('s', "scaletexture", Action = ParseAction.Store,
            Description = "A number between 0 and 1 telling the application how to resize/scale the texture when using -t.  Default 1.")]
